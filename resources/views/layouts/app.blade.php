...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background  text-gray-900 text-sm">
        ...
        <a href="#"><img src="{{ asset('img/logo-braip.png') }}" class="ml-64 w-24 mx-auto" alt="logo"></a>
        ...
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
                Add ideia from goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis odio maxime quisquam consequatur cumque corrupti nobis quod, alias vero voluptate iste? A cupiditate repudiandae amet nam, libero impedit corrupti, possimus molestiae expedita dolores aperiam. Molestias sunt nulla saepe mollitia expedita!
            </div>
            <div class="w-175">
