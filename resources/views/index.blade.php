    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card transition duration-150 ease-in  bg-white rounded-xl flex cursor-pointer">
            <div class="hidden md:block border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button
                        class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xxs uppercase rounded-xl px-4 transition duration-150 ease-in py-3">Vote</button>
                </div>
            </div>
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card transition duration-150 ease-in  bg-white rounded-xl flex cursor-pointer">
            <div class="hidden md:block border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button
                        class="w-20 bg-blue border border-gray-200 hover:border-gray-400 text-white font-bold text-xxs uppercase rounded-xl px-4 transition duration-150 ease-in py-3">Voted</button>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center md:hidden mt-4 md:mt-0">
                            <div class="bg-gray-100 text-center rounded-xl h-10 px-4 py-2 pr-8">
                                <div class="text-sm text-blue font-bold leading-none">66</div>
                                <div class="text-xxs font-semibold leading-none text-gray-400">Votes</div>
                            </div>
                            <button
                                class="w-20 bg-blue text-white border border-gray-200 font-bold text-xxs
                                uppercase rounded-xl hover:border-gray-400 transition duration-150 ease-in
                                px-4 py-3 -mx-5"
                                >
                                    Votes
        ...
        <div class="ideas-container space-y-6 my-6">
            <div class="idea-container hover:shadow-card transition duration-150 ease-in  bg-white rounded-xl flex cursor-pointer">
                <div class="hidden md:block border-r border-gray-100 px-5 py-8">
                    ...
                    <div class="mt-8">
                        <button
                            class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xxs uppercase rounded-xl px-4 transition duration-150 ease-in py-3">Voted</button>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                    ...
                    <div class="w-full flex flex-col justify-between mx-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                            ...
                            <div class="flex items-center md:hidden mt-4 md:mt-0">
                                <div class="bg-gray-100 text-center rounded-xl h-10 px-4 py-2 pr-8">
                                    <div class="text-sm font-bold leading-none">32</div>
                                    <div class="text-xxs font-semibold leading-none text-gray-400">Votes</div>
                                </div>
                                <button
                                    class="w-20 bg-gray-200 border border-gray-200 font-bold text-xxs
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center md:hidden mt-4 md:mt-0">
                            <div class="bg-gray-100 text-center rounded-xl h-10 px-4 py-2 pr-8">
                                <div class="text-sm font-bold leading-none">22</div>
                                <div class="text-xxs font-semibold leading-none text-gray-400">Votes</div>
                            </div>
                            <button
                                class="w-20 bg-gray-200 border border-gray-200 font-bold text-xxs
