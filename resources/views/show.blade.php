        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur aut molestiae aperiam deleniti quae, cupiditate eum nisi error porro quisquam est, ipsa velit, sapiente quas! Fuga quas deleniti maxime suscipit, nostrum nulla corrupti sit voluptates ex similique doloribus illum exercitationem!

                </div>
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center  text-xs text-gray-400 font-semibold space-x-2">
                        <div class="font-bold text-gray-900">Victor Siqueira</div>
                        <div>&bull;</div>
                    ...
                    <div
                        ...
                        <button
                            ...
                            <ul
                                ...
                                class="absolute w-44 text-left font-semibold bg-white shafow-dialog rounded-xl py-3 ml-8">
                ...
                <div
                   ...
                   <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex items-center space-x-3">
                            <button type="button"
                            class="flex items-center justify-center h-11 w-1/2 text-sm text-white bg-blue
                            font-semibold rounded-xl border border-blue hover:bg-blue-hover
                            transition duration-150 ease-in px-6 py-3">
                            Post Comment
                            </button>
        ...
        <div class="is-admin comment-container relative  bg-white rounded-xl flex mt-4 ">
            <div class="flex flex-1 px-4 py-6">
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center  text-xs text-gray-400 font-semibold space-x-2">
                            <div class="font-bold text-blue">Maria</div>
                            <div>&bull;</div>
                            <div>10 hours ago</div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button class="relative bg-gray-100 hover:bg-gray-200 border rounded-full h-7 transition duration-150 ease-in py-2 px-3">
                                ...
                                <ul class="hidden absolute w-44 text-left font-semibold bg-white shafow-dialog rounded-xl py-3 ml-8">
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Mark as spam</a></li>
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Posts</a></li>
                                </ul>
                            </button>
